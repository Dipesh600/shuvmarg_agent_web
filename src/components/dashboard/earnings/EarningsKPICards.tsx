...
import { Wallet, ArrowUpRight, Landmark, ArrowRightLeft, Clock, TrendingUp } from "lucide-react";
...
export default function EarningsKPICards() {
    ...
    const interval = setInterval(() => {
      ...
      setActiveId((currentId) => {
        ...
        if (container && nextCard) {
          // Only scroll the horizontal card strip
  ...
  return (
    <>
      ...
      <div
        ref={containerRef}
        className="relative z-20 flex overflow-x-auto snap-x snap-mandatory hide-scrollbar gap-4 pb-2 md:grid md:grid-cols-3 md:overflow-visible md:pb-6"
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-2.5 mb-5 relative z-10">
                ...
                <p
                  className={`text-[15px] font-semibold transition-colors duration-500 ${isActive ? "text-white/95" : "text-neutral-600"
                    }`}
                >
                  {kpi.title}
                </p>
              ...
              <div className="mb-5 relative z-10 mt-auto flex items-baseline gap-1.5">
                <span
                  className={`text-[26px] md:text-[30px] font-sans font-bold leading-none tracking-tight transition-colors duration-500 ${isActive ? "text-white" : "text-neutral-900"
                    }`}
                >
                  {kpi.value}
                </span>
              ...
              <div className="flex items-center gap-2 relative z-10">
                <span
                  className={`inline-flex items-center gap-1 text-[11px] font-bold px-2 py-0.5 rounded-full transition-colors duration-500 bg-white ${kpi.badgeColor}`}
                >
