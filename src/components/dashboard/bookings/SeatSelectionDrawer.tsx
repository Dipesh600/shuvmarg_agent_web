...
import { bookSeats } from "@/lib/seatApi";
...
export function SeatSelectionDrawer({ isOpen, onClose, trip }: SeatSelectionDrawerProps) {
  ...
  const content = (
    <>
      ...
      {/* Drawer */}
      <div 
        className="fixed bottom-0 left-0 w-full h-[90vh] bg-[#FDFDFD] shadow-2xl z-[101] flex flex-col rounded-t-3xl overflow-hidden border-t border-neutral-200 animate-in slide-in-from-bottom duration-300 ease-out"
      ...
      >
        ...
        {/* Top Tabs */}
        <div className="border-b border-neutral-200 px-6 bg-white flex justify-between items-center flex-shrink-0">
        ...
        <div className="flex-1 min-h-0 overflow-hidden flex bg-white">
          {activeTab === 'seats' && (
            <div className="w-full flex h-full min-h-0">
              {/* Left Pane - Seat Map */}
              <div className="w-1/2 border-r border-neutral-200 bg-[#F5F7FA] p-8 flex flex-col items-center overflow-y-auto min-h-0">
              {isLoading ? (
              ...
              {/* Seat Types Legend */}
              <div className="mt-8 bg-white p-4 rounded-xl border border-neutral-200 shadow-sm w-full max-w-sm">
              ...
              <div ref={rightPaneRef} className="w-1/2 overflow-y-scroll min-h-0" onScroll={() => {
                  ...
                  {trip.busDetail.fleetImages.length > 0 ? (
                    <div className="flex gap-4 overflow-x-auto pb-2 scrollbar-hide">
                      {trip.busDetail.fleetImages.map((img, i) => (
                        <img key={i} src={img} alt="Bus" className="w-[200px] h-[120px] object-cover rounded-xl border border-neutral-200 flex-shrink-0" />
                      ))}
                    </div>
                  ) : (
                    <div className="flex gap-4">
                      <div className="w-[200px] h-[120px] bg-neutral-100 rounded-xl border border-neutral-200 flex items-center justify-center text-neutral-400 text-sm">No image</div>
                      <div className="w-[200px] h-[120px] bg-neutral-100 rounded-xl border border-neutral-200 flex items-center justify-center text-neutral-400 text-sm">No image</div>
                    </div>
                  )}
                </div>
                ...
                <div className="sticky top-0 bg-white z-10 border-b border-neutral-200 px-8 flex gap-6 overflow-x-auto scrollbar-hide">
                  {[
                ...
                <div className="px-8 pb-16 space-y-12 pt-10">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        {trip.busDetail.amenities.map((item, i) => (
                          <div key={i} className="flex items-center gap-3 bg-neutral-50 p-3 rounded-xl border border-neutral-100">
                            <svg className="w-5 h-5 text-neutral-400 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                            <span className="text-[13px] font-medium text-neutral-700 capitalize">{item}</span>
                          </div>
                        ))}
                      </div>
                    ) : (
                  ...
                  <section ref={el => { sectionRefs.current['cancellation'] = el; }}>
                    <div className="bg-[#7A1D1B]/5 rounded-2xl p-6 border border-[#7A1D1B]/10">
                          ...
                          {mockBoardingPoints.map((bp, i) => (
                            <div key={i} className="relative flex items-center justify-between group">
                              <div className="flex items-center">
                                <div className="absolute left-0 w-4 h-4 rounded-full bg-white border-2 border-neutral-300 group-hover:border-green-500 transition-colors z-10 -ml-1"></div>
                                <div className="ml-6">
                      ...
                      <div>
                        ...
                        <div className="space-y-4 relative before:absolute before:inset-0 before:ml-2 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-neutral-200 before:to-transparent">
                          {mockDroppingPoints.map((dp, i) => (
                            <div key={i} className="relative flex items-center justify-between group">
                              <div className="flex items-center">
                                <div className="absolute left-0 w-4 h-4 rounded-full bg-white border-2 border-neutral-300 group-hover:border-red-500 transition-colors z-10 -ml-1"></div>
                                <div className="ml-6">
                    ...
                    <div className="bg-neutral-50 rounded-2xl p-6 border border-neutral-200">
                      ...
                      <div className="flex items-center justify-between max-w-sm mx-auto">
                        ...
                        <div className="flex-1 px-4 relative flex items-center justify-center">
                          ...
                          <div className="absolute bg-white px-2 text-[12px] font-bold text-neutral-400">
                            Duration
                          </div>
                        </div>
                        <div className="text-center">
                  ...
                  <section ref={el => { sectionRefs.current['reviews'] = el; }}>
                    ...
                    <div className="flex gap-6 items-center bg-white p-6 rounded-2xl border border-neutral-200 shadow-sm">
          ...
          {activeTab === 'points' && (
            <div className="w-full flex h-full min-h-0 bg-[#F5F7FA]">
              <div className="max-w-5xl mx-auto w-full p-8 flex flex-col min-h-0">
                <div className="flex-1 overflow-y-auto pr-4 grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                  ...
                  <div className="bg-white rounded-2xl shadow-sm border border-neutral-200 overflow-hidden flex flex-col h-fit max-h-full">
                    {/* Header */}
                    <div className="p-6 border-b border-neutral-200 bg-white sticky top-0 z-10">
              ...
              <div className="max-w-6xl mx-auto w-full p-8 flex flex-col min-h-0">
                <div className="flex-1 overflow-y-auto pr-4 grid grid-cols-1 lg:grid-cols-3 gap-6 items-start pb-20">
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-neutral-200 overflow-hidden">
                      <div className="p-6">
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="relative rounded-xl border border-neutral-300 focus-within:border-[#7A1D1B] focus-within:ring-1 focus-within:ring-[#7A1D1B] overflow-hidden transition-colors bg-white">
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-neutral-200 overflow-hidden">
                      <div className="p-6 pb-2">
                        ...
                        <div className="relative mb-4">
                          ...
                          <input 
                            type="text" 
                            className="w-full h-12 pl-11 pr-4 rounded-xl border border-neutral-300 focus:border-[#7A1D1B] focus:ring-1 focus:ring-[#7A1D1B] outline-none transition-shadow text-[14px] bg-neutral-50 focus:bg-white" 
                          ...
                          <div key={i} className="p-6 border-t border-neutral-200 border-dashed mt-4 first:border-0 first:mt-0">
                            ...
                            {expandedPassenger === i && (
                              <div className="space-y-5 animate-in fade-in slide-in-from-top-2 duration-200">
                                <div>
                                  <div className="relative rounded-xl border border-[#E05252] focus-within:border-[#E05252] focus-within:ring-1 focus-within:ring-[#E05252] overflow-hidden bg-white h-12 transition-colors">
                                ...
                                <div className="relative rounded-xl border border-neutral-300 focus-within:border-[#7A1D1B] focus-within:ring-1 focus-within:ring-[#7A1D1B] overflow-hidden bg-white h-12 transition-colors">
                                ...
                                <div>
                                  ...
                                  <div className="flex gap-4">
                                    <label className="flex-1 flex items-center justify-between px-5 py-3 border border-neutral-300 rounded-full cursor-pointer hover:bg-neutral-50 transition-colors bg-white">
                  ...
                  <div className="lg:col-span-1">
                    <div className="bg-white rounded-2xl shadow-sm border border-neutral-200 overflow-hidden p-6 sticky top-0">
                      <div className="mb-6">
                      ...
                      <div className="relative pl-6 mb-8 mt-4">
                        ...
                        <div className="absolute -left-1 top-1/2 -translate-y-1/2 bg-white text-[11px] font-medium text-neutral-500 py-2">
              ...
              <div className="max-w-6xl mx-auto w-full p-8 flex flex-col min-h-0">
                <div className="flex-1 overflow-y-auto pr-4 grid grid-cols-1 lg:grid-cols-12 gap-8 items-start pb-20">
                  ...
                  <div className="lg:col-span-7 space-y-6">
                    ...
                    <div className="bg-white rounded-2xl border border-neutral-200 overflow-hidden shadow-sm p-8 flex flex-col items-center">
                      ...
                      <div className="w-full bg-[#f8fafc] rounded-xl p-6">
        ...
        {(bookingSuccess || selectedSeats.length > 0) && (
          <div className="border-t border-neutral-200 px-8 py-4 bg-white flex-shrink-0">
            {bookingSuccess ? (
                ...
                <button 
                  onClick={async () => {
                    if (activeTab === 'seats') {
                      ...
                      setIsBooking(true);
                      try {
                        const res = await bookSeats(trip._id, selectedSeats.map((s: any) => s.id));
                        if (res.success) {
                          setBookingSuccess({ ticketId: res.ticketId, message: "Booking confirmed!" });
                        } else {
