...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full min-h-[calc(100svh+60px)] md:min-h-[calc(100svh+100px)] lg:min-h-[calc(100svh+120px)] flex flex-col overflow-hidden">
      ...
      <div className="relative z-20 w-full pb-[calc(60px+96px)] md:pb-[calc(100px+128px)] lg:pb-[calc(120px+128px)] pt-8 md:pt-24 bg-gradient-to-t from-black/90 via-black/50 to-transparent pointer-events-none">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
